...
function safeSerialize(data) {
  return data ? (0, _stringify2.default)(data).replace(/\//g, '\\/') : null;
}
...
function renderGraphiQL(data) {
  ...
  var variablesString = data.variables ? (0, _stringify2.default)(data.variables, null, 2) : null;
  var resultString = data.result ? (0, _stringify2.default)(data.result, null, 2) : null;
